...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    tl.from(imgContainerRef, 1.2, { y: 1280, ease: "ease-out" })
      ...
      .staggerFrom(lineRefs, .4, { y: 100, ease: 'ease-out', autoAlpha: 0 }, .1, 1)
      .fromTo(subtitleRef, .3, {yPercent: 50, ease: 'ease-out', autoAlpha: 0}, {yPercent: 0, autoAlpha: .5}, 2.1)

    // tl.tqo(titleRef,0,{autoAlpha:1})
