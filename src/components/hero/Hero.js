...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    tl.from(imgContainerRef, 1.2, { y: 1280, ease: "ease-out" })
      ...
      .staggerFrom(lineRefs, .4, { yPercent: 100, ease: 'ease-out', autoAlpha: 0 }, .05, 1)
    ...
    <section id="hero">
      ...
      <div className={style.hero}>
        <div className={style.headline} >
          <h1 className={style.title} ref={el => titleRef = el} data-splitting>
            Miso<em className={style.low}> è una </em>
            <br />
            associazione culturale no-profit <em className={style.low}>fondata a </em>
            Brescia.
          </h1>
          <Spacer h={5} />
